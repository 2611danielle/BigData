...
print(lista1)
lista1.remove(lista1[2]) #removeu o elemento de 'indice 2' da minha lista pelo índice. 
print(lista1) #[2,4,10]

lista2=lista1.insert(2,1000)
print(lista2) #vai resultar em 'None, pois eu salvei um comando da lista 1 nessa nova lista.
lista2=lista1.copy()
...
lista4.sort() #coloquei meus elementos em ordem crescente.
...
# w3schools (site documentação python para treinar listas)'''

'''frutas=['uva','banana','melancia','manga']
